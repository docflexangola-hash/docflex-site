  ...
  return (
    <motion.header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-paper/90 backdrop-blur-md shadow-sm border-b border-border"
          : "bg-transparent"
      }`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className={`text-sm font-semibold px-4 py-2 rounded-lg transition-all duration-300 ${
              scrolled
                ? "border border-[var(--color-brand-blue)]/30 text-[var(--color-brand-blue)] hover:bg-[var(--color-brand-blue)]/5 hover:border-[var(--color-brand-blue)]/50"
      ...
      {mobileOpen && (
        <motion.div
          className="md:hidden bg-paper/95 backdrop-blur-md border-t border-border"
        ...
        >
          <div className="container mx-auto px-6 py-4 flex flex-col gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="border border-[var(--color-brand-blue)]/30 text-[var(--color-brand-blue)] font-semibold py-2 px-4 rounded-lg text-center hover:bg-[var(--color-brand-blue)]/5 hover:border-[var(--color-brand-blue)]/50 transition-all duration-300 mt-2"
            >
              WhatsApp
            </a>
          </div>
