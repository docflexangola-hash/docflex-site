...
export function LiquidMetalButton({
  ...
  useEffect(() => {
    ...
    if (!document.getElementById(styleId)) {
      ...
      style.id = styleId;
      style.textContent = `
        .shader-button-container canvas {
          width: 100% !important;
        ...
        >
          ...
          <div
            style={{
              ...
              transformStyle: "preserve-3d",
              transition:
                "all 0.8s cubic-bezier(0.4, 0, 0.2, 1), gap 0.4s ease",
            ...
            <div
              style={{
                ...
                boxShadow: isPressed
                  ...
                  : "none",
                transition:
                  "all 0.8s cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.15s cubic-bezier(0.4, 0, 0.2, 1)",
              }}
            />
          </div>
          ...
          >
            ...
            >
              <div
                ref={shaderRef}
                className="shader-button-container"
                style={{
                  borderRadius: "100px",
                  overflow: "hidden",
                  position: "relative",
